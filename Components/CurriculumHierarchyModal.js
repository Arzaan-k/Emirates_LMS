 ...
 *
 * Manages the curriculum hierarchy - which courses are assigned to which progression levels.
 * This was previously named "Access Control" but renamed to better reflect its purpose.
 *
 * Note: For granular user data access control, see DataAccessControlModal.js
 */
export default function CurriculumHierarchyModal({ visible, onClose }) {
