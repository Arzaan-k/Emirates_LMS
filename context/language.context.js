...
const TRANSLATIONS = {
  en: {
    ...
    storeSimulation: "Store Simulation",
  ...
  hi: {
    ...
    storeSimulation: "स्टोर सिमुलेशन",
  ...
  es: {
    ...
    storeSimulation: "Simulación de tienda",
  ...
  fr: {
    ...
    joined: "Rejoint",
    storeManager: "Directeur de magasin",
    totalXP: "XP Total",
    ...
    storeSimulation: "Simulation de magasin",
